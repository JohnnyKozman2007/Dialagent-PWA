...
class _TaskScreenState extends ConsumerState<TaskScreen> {
  ...
  Stream<QuerySnapshot> _getTasksStream() async* {
    ...
    if (restaurantId == null) {
      yield* FirebaseFirestore.instance.collection('tasks').where('restaurantId', isEqualTo: '').snapshots();
      return;
    }
  ...
  void _toggleTaskAssignment(TaskModel task) async {
    ...
    await FirebaseFirestore.instance.collection('tasks').doc(task.id).update(updates);
